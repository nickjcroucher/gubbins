...
class TestAlignmentPythonMethods(unittest.TestCase):
  ...
  def test_filter_out_alignments_with_too_much_missing_data(self):
    ...
    actual_file_content = open('gubbins/tests/data/alignment_with_too_much_missing_data.aln.actual', encoding='utf-8').readlines()
    expected_file_content = open('gubbins/tests/data/alignment_with_too_much_missing_data.aln.expected',  encoding='utf-8').readlines()
  ...
  def test_reinsert_gaps_into_fasta_file(self):
    ...
    actual_file_content   = open('gubbins/tests/data/gaps_to_be_reinserted.aln.actual',    encoding='utf-8').readlines()
    expected_file_content = open('gubbins/tests/data/gaps_to_be_reinserted.aln.expected',  encoding='utf-8').readlines()
    assert actual_file_content == expected_file_content
  ...
  def test_reconvert_fasta_file(self):
    ...
    actual_file_content = open('gubbins/tests/data/reconvert_fasta_file.aln.actual',  encoding='utf-8').readlines()
    expected_file_content = open('gubbins/tests/data/reconvert_fasta_file.aln.expected',  encoding='utf-8').readlines()
    assert actual_file_content == expected_file_content
