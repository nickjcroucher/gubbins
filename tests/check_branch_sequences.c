...
int test_bases_in_recombinations(int block_size)
{
	...
	return calculate_number_of_bases_in_recombinations_excluding_gaps(block_coords, block_size, child_sequence, snp_locations,12,0);
}
...
int test_bases_in_recombinations_with_gaps(int block_size)
{
	...
	return calculate_number_of_bases_in_recombinations_excluding_gaps(block_coords, block_size, child_sequence, snp_locations,16,0);
}
