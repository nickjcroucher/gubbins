...
START_TEST (check_gubbins_no_recombinations)
{
	...
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.tab") == 1);
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.vcf") == 1);
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.phylip") == 1);
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.snp_sites.aln") == 1);
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.stats") == 1);
	ck_assert_msg(file_exists("../tests/data/no_recombinations.tre.gff") == 1);
	
  ck_assert_msg(number_of_recombinations_in_file("../tests/data/no_recombinations.tre.tab") == 0);
  ck_assert_msg(compare_files("../tests/data/no_recombinations.tre","../tests/data/no_recombinations.expected.tre") == 1);
  ck_assert_msg(compare_files("../tests/data/no_recombinations.tre.branch_snps.tab","../tests/data/no_recombinations.tre.branch_snps.expected.tab") == 1);
...
START_TEST (check_gubbins_one_recombination)
{
	...
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.tab") == 1);
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.vcf") == 1);
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.phylip") == 1);
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.stats") == 1);
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.gff") == 1);
	ck_assert_msg(file_exists("../tests/data/one_recombination.tre.snp_sites.aln") == 1);
	
	ck_assert_msg(number_of_recombinations_in_file("../tests/data/one_recombination.tre.tab") == 1);
	ck_assert_msg(compare_files("../tests/data/one_recombination.tre.vcf","../tests/data/one_recombination.expected.vcf") == 1);
	ck_assert_msg(compare_files("../tests/data/one_recombination.tre.stats","../tests/data/one_recombination.expected.stats") == 1);
	ck_assert_msg(compare_files("../tests/data/one_recombination.tre.branch_snps.tab","../tests/data/one_recombination.tre.branch_snps.expected.tab") == 1);
	ck_assert_msg(compare_files("../tests/data/one_recombination.tre.tab","../tests/data/one_recombination.tre.expected.tab") == 1);
	ck_assert_msg(compare_files("../tests/data/one_recombination.tre.gff","../tests/data/one_recombination.tre.expected.gff") == 1);
...
START_TEST (check_gubbins_multiple_recombinations)
{
	...
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.tab") == 1);
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.vcf") == 1);
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.phylip") == 1);
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.stats") == 1);
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.gff") == 1);
	ck_assert_msg(file_exists("../tests/data/multiple_recombinations.tre.snp_sites.aln") == 1);

	ck_assert_msg(number_of_recombinations_in_file("../tests/data/multiple_recombinations.tre.tab") == 3);
  ck_assert_msg(compare_files("../tests/data/multiple_recombinations.tre","../tests/data/multiple_recombinations.expected.tre") == 1);
  ck_assert_msg(compare_files("../tests/data/multiple_recombinations.tre.branch_snps.tab","../tests/data/multiple_recombinations.tre.branch_snps.expected.tab") == 1);
...
START_TEST (check_recombination_at_root)
{
    ...
    ck_assert_msg(compare_files("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.tab","../tests/data/recombination_at_root/expected_RAxML_result.recombination_at_root.iteration_1.tab") == 1);
    
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.vcf")             == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.tab")             == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.stats")           == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.snp_sites.aln")   == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.phylip")          == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.gff")             == 1);
    ck_assert_msg(file_exists("../tests/data/recombination_at_root/RAxML_result.recombination_at_root.iteration_1.branch_snps.tab") == 1);
