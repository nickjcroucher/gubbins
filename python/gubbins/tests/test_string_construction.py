...
class TestStringConstruction(unittest.TestCase):
  ...
  def test_fasttree_regex_for_file_deletions(self):
    assert common.GubbinsCommon.fasttree_regex_for_file_deletions('AAA', 5) == ['AAA.(gaps|vcf|snp_sites|phylip)', '^AAA.iteration_1', '^AAA.iteration_2', '^AAA.iteration_3', '^AAA.iteration_4']
