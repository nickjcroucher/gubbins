...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Note from <a.j.delaney@brighton.ac.uk>: this does not work well where
  ...
  # the file saucyvm.pp in the manifests_path directory.
  #
  ...
  config.vm.provision "puppet" do |puppet|
     ...
     puppet.manifest_file  = "saucyvm.pp"
  end
